...
public class Op_MINUS implements IOperatorExecution {
	...
	public Constant execute(Constant[] args) throws IllegalExpressionException{
		...
		if( BaseDataMeta.DataType.DATATYPE_NULL ==  first.getDataType()
			...
			BigDecimal result = new BigDecimal(first.getDoubleValue()).subtract(new BigDecimal(second.getDoubleValue()));
			...
			BigDecimal result = new BigDecimal(first.getFloatValue()).subtract(new BigDecimal(second.getFloatValue()));
