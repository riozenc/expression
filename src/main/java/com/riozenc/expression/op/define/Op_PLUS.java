...
//			Double result = first.getDoubleValue() + second.getDoubleValue();
			BigDecimal result = new BigDecimal(first.getDoubleValue()).add(new BigDecimal(second.getDoubleValue()));
...
//			Float result = first.getFloatValue() + second.getFloatValue();
			BigDecimal result = new BigDecimal(first.getFloatValue()).add(new BigDecimal(second.getFloatValue()));
