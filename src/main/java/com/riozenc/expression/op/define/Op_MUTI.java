...
//			Double result = first.getDoubleValue() * second.getDoubleValue();
			BigDecimal result = new BigDecimal(first.getDoubleValue()).multiply(new BigDecimal(second.getDoubleValue()));
...
//			Float result = first.getFloatValue() * second.getFloatValue();
			BigDecimal result = new BigDecimal(first.getFloatValue()).multiply(new BigDecimal(second.getFloatValue()));
