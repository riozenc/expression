...
//			BigDecimal[] result = new BigDecimal(first.getDoubleValue()).divideAndRemainder(new BigDecimal(second.getDoubleValue()));
//			return new Constant(BaseDataMeta.DataType.DATATYPE_DOUBLE , result[1]);
...
//			BigDecimal[] result = new BigDecimal(first.getFloatValue()).divideAndRemainder(new BigDecimal(second.getFloatValue()));
//			return new Constant(BaseDataMeta.DataType.DATATYPE_FLOAT , result[1]);
